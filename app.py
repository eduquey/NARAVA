...
# Usamos r""" (raw string) para evitar que Python interprete caracteres especiales de CSS
ESTILOS_CSS = r"""
<style>
...
with con1:
    st.markdown("""
    <h2 style="color:white !important; font-size:3.5rem; line-height:1; margin-bottom:30px; font-family:'Playfair Display', serif;">CONTÁCTANOS</h2>
...
""", unsafe_allow_html=True)flor_b64 = get_image_base64(find_image("flor"))
logo_b64 = get_image_base64(find_image("logo"))
